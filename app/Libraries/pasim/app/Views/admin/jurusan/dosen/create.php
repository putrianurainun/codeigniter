...
<!-- form input mask -->
  <div class="col-md-12 col-sm-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form class="form-horizontal form-label-left" method="post" action="/DosenController/save">
          <?php csrf_field(); ?>
          
          <div class="form-group row">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">NIDN</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="nidn" required="" autofocus="" autocomplete="off">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="gelar" required="" autofocus="" autocomplete="off">
            </div>
          </div>
         ...
         <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="pendidikan" required="" autofocus="" autocomplete="off">
            </div>
          </div>  
           ...
           <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
              <input type="text" class="form-control" name="akademik" required="" autofocus="" autocomplete="off">
            </div>
          </div>        
